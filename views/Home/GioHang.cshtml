                                ...
                                @if (Model != null && Model.Any())
                                {
                                    foreach (var item in Model)
                                    {
                                        ...
                                        <tr>
                                            ...
                                            <td class="uren-product-price"><span class="amount">@String.Format("{0:C}", item.Gia)</span></td>
                                            <td class="quantity">
                                            ...
                                            <td class="product-subtotal">
                                                <span class="amount">@String.Format("{0:N0}", item.Gia * item.SoLuong)</span>
                                            </td>
                                        </tr>
                    ...
                    <div class="row">
                        <div class="col-md-5 ml-auto">
                            <div class="cart-page-total">
                                <h2>Thành tiền</h2>
                                <ul>
                                    <li>Tổng tiền <span>@String.Format("{0:N0}", ViewBag.TongTien)</span></li>
                                </ul>
