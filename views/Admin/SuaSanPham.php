        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    @Html.DropDownListFor(model => model.MaDanhMuc, new SelectList(ViewBag.DanhMuc, "MaDanhMuc", "TenDanhMuc", Model.MaDanhMuc), "Chọn Danh Mục", new { @class = "form-control" })
                    @Html.ValidationMessageFor(model => model.MaDanhMuc, "", new { @class = "text-danger" })
                </div>

                <div class="form-group">
                    @Html.LabelFor(model => model.MaHang, "Hãng Sản Phẩm") 
                    @Html.DropDownListFor(model => model.MaHang, new SelectList(ViewBag.Hang, "MaHang", "TenHang", Model.MaHang), "Chọn Hãng", new { @class = "form-control" })     
